...
var file_accounts_proto_rawDesc = []byte{
	...
	,
...
var file_accounts_proto_depIdxs = []int32{
	0, // 0: AccountService.AuthenticateByEmailAndPassword:input_type -> User
	1, // 1: AccountService.AuthenticateByEmailAndPassword:output_type -> Account
...
func (c *accountServiceClient) AuthenticateByEmailAndPassword(ctx context.Context, in *User, opts ...grpc.CallOption) (*Account, error) {
	out := new(Account)
	err := c.cc.Invoke(ctx, "/AccountService/AuthenticateByEmailAndPassword", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AccountService_AuthenticateByEmailAndPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/AccountService/AuthenticateByEmailAndPassword",
	}
